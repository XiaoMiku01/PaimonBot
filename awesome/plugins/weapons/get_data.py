...
from awesome.plugins.weapons import read_index
...
def auto_correct(name: str) -> list:
    if not os.path.exists("./weapon_index.json"):
        read_index.run()
    with open("./weapon_index.json", "r", encoding="utf-8") as weapon_index_file:
